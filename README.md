...
> В интерфейсе такие устройства помечены как «только бронь», и кнопка у них
> называется **«Забронировать»**, а не «Занять»: нового устройства в системе
> после нажатия не появится, и ждать его не нужно. Занять сетевой интерфейс
> здесь означает «записать за собой», а подключаться к нему по-прежнему
> нужно физически.
